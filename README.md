...
- `apps/api`: Go/Gin API 和 worker 入口
- `packages/*`: 类型、API client、认证、工具和基础 UI
- `docs`: PRD、TDD、API 与 UI 设计约定

当前前端使用少量 demo 数据展示核心信息架构；API 已提供 `/api/v1` 公开资源、认证占位和 recruiter 受保护工作台骨架，下一步接入 PostgreSQL repository、会话认证和 Asynq pipeline。
